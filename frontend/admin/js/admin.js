    ...
    return `
      <div class="grupo-mesa">
        <button type="button" class="grupo-mesa__cabecalho" data-toggle-grupo="${idGrupo}">
          <span class="grupo-mesa__titulo">${g.avulsa ? '🧾' : '🍽️'} ${escaparHtmlAdmin(g.titulo)}${g.subtitulo ? ` <span class="grupo-mesa__subtitulo">— ${escaparHtmlAdmin(g.subtitulo)}</span>` : ''}</span>
