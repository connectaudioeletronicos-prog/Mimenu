        ...
        : fechadas.map(c => `
          <div class="comanda-movimentacao">
            <div class="comanda-movimentacao__cabecalho">
              ...
              <span style="font-size:0.78rem;color:var(--admin-cor-texto-claro);">Atendida por ${escaparHtmlAdmin(rotularNomeComCargo(c.funcionario_nome, c.funcionario_cargo))}</span>
            </div>
            <div class="comanda-movimentacao__rodape">
              ...
              <span style="font-size:0.75rem;color:var(--admin-cor-texto-claro);">${c.pago_no_caixa ? `Recebido por ${escaparHtmlAdmin(rotularNomeComCargo(c.fechada_por_funcionario_nome, c.fechada_por_funcionario_cargo))}` : 'Recebido pelo garçom'}</span>
            </div>
          </div>
        `).join('');
    }
