...
async function abrirResumoFuncionario(id) {
  try {
    ...
    // Trocou de funcionario -> volta pra aba "Pedidos" e limpa o
...
async function abrirDetalheHistoricoComanda(comandaId) {
  ...
  try {
    ...
    conteudo.innerHTML = `
      ...
      <div class="comanda-movimentacao__linha-item"><span>Forma de pagamento</span><span>${formasLegenda[comanda.forma_pagamento] || comanda.forma_pagamento || '-'}</span></div>
